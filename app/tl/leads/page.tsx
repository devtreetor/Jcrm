...
export default function TLLeadsPage() {
  ...
  if (loading) return <ActivityIndicator color="#7c3aed" size="large" style={{ marginTop: 48 }} />;
  ...
  if (leads.length === 0) {
    return (
      <View style={styles.emptyState}>
        ...
        <Text style={styles.emptyMessage}>Leads assigned to your team callers will appear here</Text>
      </View>
    );
  }
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Team Leads ({leads.length})</Text>
      <FlatList
        data={leads}
