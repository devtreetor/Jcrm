...
const styles = StyleSheet.create({
  ...
  formCard: { backgroundColor: 'var(--color-surface-lighter)', borderRadius: 12, padding: 16, marginBottom: 16 },
  formTitle: { fontSize: 16, fontWeight: '600', color: 'var(--color-text-primary)', marginBottom: 12 },
  input: {
    height: 48, borderWidth: 1, borderColor: 'var(--color-border)', borderRadius: 10,
    paddingHorizontal: 16, fontSize: 15, color: 'var(--color-text-primary)', backgroundColor: 'var(--color-surface)', marginBottom: 12,
  },
  dropdownLabel: { fontSize: 13, color: 'var(--color-text-secondary)', marginBottom: 8 },
  roleRow: { flexDirection: 'row', gap: 8, marginBottom: 12 },
  roleChip: { paddingHorizontal: 14, paddingVertical: 8, borderRadius: 16, backgroundColor: 'var(--color-surface)' },
  roleChipActive: { backgroundColor: '#2563eb' },
  roleChipText: { fontSize: 13, color: 'var(--color-text-secondary)', fontWeight: '500' },
  roleChipTextActive: { color: 'var(--color-text-primary)' },
  ...
  userCard: {
    ...
    backgroundColor: 'var(--color-surface-lighter)', borderRadius: 10, padding: 14, marginBottom: 8,
  },
  userCardInactive: { opacity: 0.5 },
  userInfo: { flex: 1 },
  userName: { fontSize: 15, fontWeight: '600', color: 'var(--color-text-primary)' },
  userEmail: { fontSize: 12, color: 'var(--color-text-secondary)', marginTop: 2 },
  ...
  toggleText: { fontSize: 11, fontWeight: '600', color: 'var(--color-text-secondary)' },
