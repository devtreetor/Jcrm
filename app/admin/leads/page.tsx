...
const styles = StyleSheet.create({
  ...
  title: { fontSize: 24, fontWeight: '800', color: 'var(--color-text-primary)', fontFamily: 'Montserrat' },
  cancelSelect: { fontSize: 14, color: 'var(--color-primary)', fontWeight: '600' },
  searchInput: {
    height: 52, 
    borderWidth: 1, 
  ...
  emptyTitle: { fontSize: 20, fontWeight: '700', color: 'var(--color-text-primary)', marginBottom: 8, fontFamily: 'Montserrat' },
  emptyMessage: { fontSize: 15, color: 'var(--color-text-secondary)', textAlign: 'center', marginBottom: 24, fontFamily: 'Poppins' },
  emptyCta: { backgroundColor: 'var(--color-primary)', paddingHorizontal: 28, paddingVertical: 14, borderRadius: 14 },
  ...
  leadCardSelected: { borderColor: 'var(--color-secondary)', borderWidth: 2 },
  checkbox: { 
    width: 24, 
    height: 24, 
    borderRadius: 8, 
  ...
  checkboxChecked: { backgroundColor: 'var(--color-secondary)', borderColor: 'var(--color-secondary)' },
  checkmark: { color: '#fff', fontSize: 14, fontWeight: '800' },
  leadInfo: { flex: 1 },
  schoolName: { fontSize: 17, fontWeight: '700', color: 'var(--color-text-primary)', fontFamily: 'Poppins' },
  leadMeta: { fontSize: 13, color: 'var(--color-text-secondary)', marginTop: 4, fontFamily: 'Poppins' },
